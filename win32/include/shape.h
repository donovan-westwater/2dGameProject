...
#include <SDL.h>
/*
This is based off DJ's shape code but without circles
if needed, ill add them later

Might need to add a color script later.
...
* @param r the rect to base it on
*/
Shape shape_from_sdl_rect(SDL_Rect r);
...
*/
#ifndef rect_set
#define rect_set(r,a,b,c,d) (r.x = a,r.y = b, r.w =c, r.h = d)
#endif
...
* @param
*/
#define circle_set(circle,a,b,c) (circle.x = a,circle.y = b, circle.r = c)
...
*/
#define edge_set(e,a,b,c,d) (e.x1 = a,e.y1 = b, e.x2 = c, e.y2 = d)
...
*/
#define edge_copy(dst,src) (dst.x1 = src.x1,dst.y1 = src.y1,dst.x2 = src.x2,dst.y2 = src.y2)
...
* @return true if there is an intersection, false otherwise
*/
Uint8 edge_circle_intersection_poc(Edge e, Circle c, Vector2D *poc, Vector2D *normal);
