...
#include <SDL.h>
/*
This list data structure is a continous chunk of memory used to implment the stack system found in the collision system
(Like most of this, DJ made this)
*/
...
* @return -1 on error, 0 otherwise
*/
int list_delete_nth(List *list, Uint32 n);
...
*/
int list_delete_last(List *list);
...
/**
* @brief same as list_concat but b is freed when complete
* @note the new address of a is returned
...
* @return NULL on failure, a pointer to the new list otherwise
*/
List *list_concat_free(List *a, List *b);
