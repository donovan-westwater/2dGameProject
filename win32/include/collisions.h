/*
* Goals: Using the shape math from DJ's ymir project, create a collsion system. Should be very simple. it is mainly
* going to be used for creating hitboxes for the player and the monsters
* 
* Create static bodies via a space file
*
*
*
*
*/
//For testing, need rect overlap and rect to edge and rect to rect detections!
